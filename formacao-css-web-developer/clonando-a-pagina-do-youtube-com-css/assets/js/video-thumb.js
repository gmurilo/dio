...
function video_thumbs () {
  ...
  for( $i = 0; $i < $videos.length; $i++ ) {
    $html += "<div class='sidebar-video'><a href='' target='_blank'>";
    $html += "<img src='./assets/images/"+$videos[$i].img+"' alt='"+$videos[$i].title+"'/>";
    $html += "<div class='sidebar-video-info'>";
    $html += "<div><h2>"+$videos[$i].title+"</h2>";
    $html += "<h3>"+$videos[$i].channel+"</h3></div>";
